package com.franklin.client.impl.client.action;

import com.franklin.client.sdk.client.ConnectionInfo;
import com.franklin.client.sdk.client.OkSocketOptions;
import com.franklin.client.sdk.client.action.ISocketActionListener;
...
import com.franklin.core.utils.SLog;
import com.franklin.interfaces.basic.AbsLoopThread;
import com.franklin.interfaces.common_interfacies.dispatcher.IRegister;
...
import static com.franklin.client.sdk.client.action.IAction.ACTION_CONNECTION_FAILED;
import static com.franklin.client.sdk.client.action.IAction.ACTION_CONNECTION_SUCCESS;
import static com.franklin.client.sdk.client.action.IAction.ACTION_DISCONNECTION;
import static com.franklin.client.sdk.client.action.IAction.ACTION_READ_THREAD_SHUTDOWN;
import static com.franklin.client.sdk.client.action.IAction.ACTION_READ_THREAD_START;
import static com.franklin.client.sdk.client.action.IAction.ACTION_WRITE_THREAD_SHUTDOWN;
import static com.franklin.client.sdk.client.action.IAction.ACTION_WRITE_THREAD_START;
import static com.franklin.core.iocore.interfaces.IOAction.ACTION_PULSE_REQUEST;
import static com.franklin.core.iocore.interfaces.IOAction.ACTION_READ_COMPLETE;
import static com.franklin.core.iocore.interfaces.IOAction.ACTION_WRITE_COMPLETE;
